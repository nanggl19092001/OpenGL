...
int main(void)
{
    ...
    GLCall(glBufferData(GL_ARRAY_BUFFER, std::size(verticesPositions) * sizeof(float), verticesPositions, GL_STATIC_DRAW));
    ...
    int locationColor = glGetUniformLocation(shader, "u_Color");
